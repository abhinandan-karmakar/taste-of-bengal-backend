...
public class AddressController {
	...
	@GetMapping("")
	public ResponseEntity<List<AddressResponse>> getAllAddressOfTheUser() {
		return ResponseEntity.status(HttpStatus.OK).body(addressService.getAllAddressOfTheUser());
	}

	@PostMapping("")
	public ResponseEntity<String> addAddress(@RequestBody AddressRequest addressRequest) {

		return ResponseEntity.status(HttpStatus.OK).body(addressService.addAddress(addressRequest));
	}
